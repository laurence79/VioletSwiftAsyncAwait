...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/DaemonLaurence/VioletSwiftAsyncAwait'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'DaemonLaurence' => 'laurence@hartgill.co.uk' }
  s.source           = { :git => 'https://github.com/DaemonLaurence/VioletSwiftAsyncAwait.git', :tag => s.version.to_s }
